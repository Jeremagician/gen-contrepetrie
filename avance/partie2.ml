...
(* Votre pere a l'air mutin *)
let mondico = ajout (mot_of_string "pere") mondico;;
let mondico = ajout (mot_of_string "mutin") mondico;;
let mondico = ajout (mot_of_string "mere") mondico;;
let mondico = ajout (mot_of_string "putin") mondico;;
...
let mondico = ajout (mot_of_string "mame") mondico;;
...
let rec ajout_dico (mot:mot) (dico:dico):dico  = 
   match dico with
    ...
    | DNode(dic1, smot, dic2) -> if mot > smot then DNode(dic1, smot, (ajout_dico mot dic2)) else DNode((ajout_dico mot dic1), smot, dic2);;
